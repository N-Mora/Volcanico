...
public class VolcanService implements IVolcansService {
	...
	public VolcanService() {
		...
		this.Volcans = new ArrayList<>(Arrays.asList(
				...
				new Volcan("Vesuve", "Italie", "Plinien (VEI=4-6)", "rift", "Destruction Pompei", 1944, "Vesuve.jpg",
						40.8223, 14.4289),
	...
	@Override
	public List<Volcan> getVolcans() {
		return Volcans;
	}

	@Override
	public void setVolcans(List<Volcan> volcans) {
		Volcans = volcans;
	}
	...
	@Override
	public List<Volcan> addVolcan(Volcan v) {
		this.Volcans.add(v);
		return Volcans;
	}
